...
namespace VolatileHordes.Tracking
{
    public class LimitManager
    {
        ...
        public readonly int GameMaximumZombies = GamePrefs.GetInt(EnumGamePrefs.MaxSpawnedZombies);
        public readonly int DesiredMaximumZombies;
            ...
            LimitSettings limitSettings)
        {
            ...
            DesiredMaximumZombies = Math.Max(15, GameMaximumZombies - limitSettings.BufferZombies);
        }
        ...
        {
            var amount = Math.Max(0, Math.Min(desired, DesiredMaximumZombies - CurrentlyActiveZombies));
